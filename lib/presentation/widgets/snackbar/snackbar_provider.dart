...
class SnackBarProvider extends StatefulWidget with DiagnosticableTreeMixin {
  ...
  static SnackBarProviderState? of(BuildContext context) {
    final SnackBarProviderState? result =
        context.findAncestorStateOfType<SnackBarProviderState>();
    if (result != null) {
      return result;
    }
    ...
    throw FlutterError.fromParts(<DiagnosticsNode>[
      ErrorSummary(
        'SnackBarProvider.of() called with a context that does not contain a SnackBarProvider.',
      ),
      ErrorDescription(
